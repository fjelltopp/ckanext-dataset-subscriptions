...
setup(
    name='''ckanext-dataset-subscriptions''',
    ...
    url='https://github.com/fjelltopp/ckanext-dataset-subscriptions',
    ...
    entry_points='''
        [ckan.plugins]
        dataset_subscriptions=ckanext.dataset_subscriptions.plugin:DatasetSubscriptionsPlugin
